...
int inzstruct_priors(struct_priors *priors,double *PRIORS)
{
    /*K*/
...
int inzstruct_data(struct_data *data,double *QFAI,double *QFADy,double *QFADx,double *QFADNoORF,double *QFADNoTIME)
{
	int i;
  long size;
	data->L=QFAI[0];
