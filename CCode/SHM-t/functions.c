...
D_MH->hP=0.2;
		...
		D_para->K_o_l[l]=MCMC_base(RNG,D,D_para,D_priors,&D_MH->accept_K,&D_MH->hK,D_para->K_o_l[l],MCMC_K_o_l,l,-999);
		D_para->r_o_l[l]=MCMC_base(RNG,D,D_para,D_priors,&D_MH->accept_K,&D_MH->hr,D_para->r_o_l[l],MCMC_r_o_l,l,-999);
